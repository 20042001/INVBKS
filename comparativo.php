    ...
    <div class="row">
      <!--INICIA CODIGO DE REPORTE-->
        <center><h2>Burger King - <?php setlocale(LC_ALL,"es_ES"); echo date("F");?>/<?php echo date("Y");?></h2>
          <h4>Cuadro de diferencias diarias</h4></center>
          <table class="table table-hover table-condensed table-bordered" border="0">       
            ...
            <?php
             ...
             $W="select cr.ingredient, 
              ...
              cr.open_inv,
              cr.t_use, 
              ((cr.trns_out+cr.waste+cr.t_use+sum(fis.actinv))-(cr.open_inv+cr.recpt+cr.trns_in)) diferencia 
              from z1_mysql cr inner join z1_invfisico fis on cr.ingredient=fis.ingredient 
              where cr.n_bk='$nbk' and fis.nbk='$nbk' and cr.descript != '^^^^^^^^' group by cr.ingredient;";
            ...
            <?php
              if($ver[9]>=0){?>
                ...
                <td class="verdde"><?php echo $ver[3] ?></td>
                <td class="verdde"><?php echo $ver[4] ?></td>
                <td class="verdde"><?php echo $ver[5] ?></td>
                <td class="verdde"><?php echo $ver[6] ?></td>
                <td class="verdde"><?php echo $ver[7] ?></td>
                <td class="verdde"><?php echo $ver[8] ?></td>
                <td class="verdde"><b><?php echo number_format($ver[9], 2) ?></b></td>  
            <?php   
              }else{
            ?>  <td class="rojjo"><?php echo $ver[0] ?></td>
                <td class="rojjo"><?php echo $ver[1] ?></td>
                <td class="rojjo"><?php echo number_format($ver[2], 2) ?></td>
                <td class="rojjo"><?php echo $ver[3] ?></td>
                <td class="rojjo"><?php echo $ver[4] ?></td>
                <td class="rojjo"><?php echo $ver[5] ?></td>
                <td class="rojjo"><?php echo $ver[6] ?></td>
                <td class="rojjo"><?php echo $ver[7] ?></td>
                <td class="rojjo"><?php echo $ver[8] ?></td>
