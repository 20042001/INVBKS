  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body letra">
        ...
        <label>CAJAS/CUBETAS</label>
        <input type="number" name="" id="Fisicou" class="form-control input-sm">
        <label>PAQUETES/BOLSAS</label>
        <input type="number" name="" id="Vencidou" class="form-control input-sm">
        <label>UNIDADES/ONZAS</label>
        <input type="number" name="" id="Danadou" class="form-control input-sm">
       
      <div class="modal-footer">
        <button type="button" class="btn btn-warning" id="actualizaDatos3" data-dismiss="modal"><label>Actualizar</label></button>
      </div>
    </div>
  </div>
</div>
...
<script type="text/javascript">
  	...
  	$('#actualizaDatos3').click(function(){
  		actualizaDatos3();
  	});
